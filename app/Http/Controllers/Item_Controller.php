    ...
    public function item_list()
    {
        ...
        if($item){
        	foreach ($item as $key => $value) {
	            ...
	            $data[$key][] = $item[$key]->option;
	            // $data[$key][] = $item[$key]->sy_id;
	            // $data[$key][] = $item[$key]->semester_id;
	            // $data[$key][] = $item[$key]->created_at;
	            // $data[$key][] = $item[$key]->updated_at;
                $data[$key][] = '<div class="btn-group"><button type="submit" class="btn btn-info" id="update-item-button" data-id="'.$item[$key]->id.'">
                <i class="fa fa-lg fa-edit"></i></button><button type="submit" class="btn btn-warning" id="delete-item-button" data-id="'.$item[$key]->id.'">
